...
class Solver:
    ...
    def train(self, model, optimizer, loss_function, num_epochs=1, print_every=100):
        train_class_loss = []
        train_bbox_loss = []
        valid_class_loss = []
        valid_bbox_loss = []
        for i in range(num_epochs):
            ...
            for batch_idx, (img_input, gt_bbox_locs, gt_bbox_labels) in enumerate(self.train_loader):
                ...
                gt_bbox_locs = Variable(gt_bbox_locs)
                gt_bbox_labels = Variable(gt_bbox_labels)
            ...
            print('--------')
        return train_class_loss, train_bbox_loss, valid_class_loss, valid_bbox_loss
